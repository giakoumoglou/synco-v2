# --------------------------------------------------------
# Reversible Multi-View Vision Transformer (RevMVIT) implementation
...
from .rev_vit import RevBackProp, RevViT
...
class ReversibleMViT(nn.Module):
    """
    This module adds reversibility on top of Multiscale Vision Transformer (MViT).
    """
    def __init__(
        self,
        img_size=224,
...
def rev_mvit_base_patch16_224(pretrained=False, **kwargs):
    model = ReversibleMViT(
        img_size=(224, 224),
        patch_kernel=(7, 7),
        patch_stride=(4, 4),
        patch_padding=(3, 3),
