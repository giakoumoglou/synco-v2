# --------------------------------------------------------
# Reversible Swin Transformer (RevSwin) implementation
# Copyright (c) 2025 Imperial College London
# Licensed under The MIT License
# Written by Ze Liu, Yutong Lin, Yixuan Wei
# Edited by Karttikeya Mangalam
...
def rev_swin_tiny_patch4_window7_224(pretrained=False, **kwargs):
    model = ReversibleSwinTransformer(
        img_size=224,
        patch_size=4,
        embed_dim=96,
        depths=[2, 2, 6, 2],
...
def rev_swin_small_patch4_window7_224(pretrained=False, **kwargs):
    model = ReversibleSwinTransformer(
        img_size=224,
        patch_size=4,
        embed_dim=96,
...
def rev_swin_base_patch4_window7_224(pretrained=False, **kwargs):
    model = ReversibleSwinTransformer(
        img_size=224,
        patch_size=4,
        embed_dim=128,
...
def rev_swin_large_patch4_window7_224(pretrained=False, **kwargs):
    model = ReversibleSwinTransformer(
        img_size=224,
        patch_size=4,
        embed_dim=192,
