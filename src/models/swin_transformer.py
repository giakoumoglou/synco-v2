...
__all__ = [
    ...
    # trick: swin transformer with batch norm instead of layer norm before the final classifier
    'swin_tiny_bn_patch4_window7_224', 
    'swin_small_bn_patch4_window7_224', 
    'swin_base_bn_patch4_window7_224', 
    'swin_large_bn_patch4_window7_224',
]
